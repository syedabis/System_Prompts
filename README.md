...
### 2. 💻 Software Engineering & Security (`/software-engineering`)
...
### 3. 📣 Social Media & Growth (`/social-media-and-growth`)
...
### 4. 📧 Sales, Marketing & Copywriting (`/sales-and-marketing`)
...
### 5. 👥 HR & Talent Acquisition (`/hr-and-recruiting`)
...
### 6. ⚙️ Operations & Process Management (`/operations-and-finance`)
...
### 7. 🛠️ Customer Support & Support Operations (`/customer-support`)
...
### 8. ⚡ Popular AI Tools & Agent System Prompts (`/ai-tool-system-prompts`)
