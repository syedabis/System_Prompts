...
├── voice-agents/             # Conversational Voice & Telephony AI Agents (Vapi, Bland, Retell)
...
- **[`n8n_ecommerce_chatbot.md`](./n8n-prompts/n8n_ecommerce_chatbot.md)**: Specialized n8n workflow chatbot prompt for online stores (Order tracking, shipping, 30-day returns, featured products).
...
- **[`n8n_travel_agency_chatbot.md`](./n8n-prompts/n8n_travel_agency_chatbot.md)**: Specialized n8n workflow chatbot prompt for travel agencies (Tour packages, deposit/cancellation policies, visa assistance, group discounts).
...
### 4. 💻 Software Engineering & Security (`/software-engineering`)
...
### 5. 📣 Social Media & Growth (`/social-media-and-growth`)
...
### 6. 📧 Sales, Marketing & Copywriting (`/sales-and-marketing`)
...
### 7. 👥 HR & Talent Acquisition (`/hr-and-recruiting`)
...
### 8. ⚙️ Operations & Process Management (`/operations-and-finance`)
...
### 9. 🛠️ Customer Support & Support Operations (`/customer-support`)
...
### 10. ⚡ Popular AI Tools & Agent System Prompts (`/ai-tool-system-prompts`)
